...
public class ContenedorIngresoJugadores extends VBox {
    ...
    public ContenedorIngresoJugadores(Stage stage) {
        ...
        BotonSiguienteEventHandler botonSiguienteHandler = new BotonSiguienteEventHandler(stage,nombreJugador1,nombreJugador2);
        botonSiguiente.setOnAction(botonSiguienteHandler);
