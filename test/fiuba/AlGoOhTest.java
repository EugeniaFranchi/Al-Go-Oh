...
public class AlGoOhTest {
	...
	@Test
	public void testActivarEfectoDeAgujeroNegroMandaAlCementerioATodasLasCartasMonstruo() {
		//Arrange
		Jugador jugador1 = new Jugador("Gio");
		Jugador jugador2 = new Jugador("Mari");	
		EfectoMagica vaciamiento = new EfectoAgujeroNegro();
		...
		CartaMagica agujeroNegro = new CartaMagica("Agujero Negro",vaciamiento,jugador1);
		...
		//Act
		agujeroNegro.activarEfecto( jugador2);
