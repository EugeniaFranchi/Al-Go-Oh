...
import fiuba.modelo.excepciones.JugadorGanoElDueloError;
import fiuba.modelo.excepciones.JugadorPerdioElDueloError;
...
public class JugadorTest {
	...
	public void testElJugadorPierdeSiSuVidaLlegaACero() {
        ...
        try {
    		jugador2.recibirAtaqueDirecto(monstruo);
		} catch (JugadorPerdioElDueloError e) {
			seLanzoError = true;
		}
	...
	public void testElJugadorPierdeSiSeQuedaSinCartasEnElMazo() {
		...
		} catch (JugadorGanoElDueloError e) {
